    ...
    <div className="site-shell">
      ...
      <footer className="site-footer">
        <div className="footer-lead">
          ...
          <h2>The motion opens the door. The records do the real work.</h2>
          <p>
            Download the vault, play the splash gate, or send a note if you want a custom world built around your own
            release.
          </p>
        </div>
