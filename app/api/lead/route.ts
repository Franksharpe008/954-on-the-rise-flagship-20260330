...
const defaultRecipients = "954ontherise@gmail.com,franksharpe008@gmail.com";
...
export async function POST(request: Request) {
  try {
    ...
    const fromEmail = process.env.BREVO_FROM_EMAIL || "franksharpe008@gmail.com";
    const fromName = process.env.BREVO_FROM_NAME || "954 On The Rise";
    ...
    const res = await fetch("https://api.brevo.com/v3/smtp/email", {
      ...
      body: JSON.stringify({
        ...
        to: toList,
        replyTo: { email, name },
        subject: `New 954 On The Rise inquiry: ${name}`,
        textContent: [
          `Name: ${name}`,
          `Email: ${email}`,
