  ...
  return (
    <section className="page-shell">
      <Reveal className="page-intro">
        ...
        <p>
          The color, the motion, the splash gate, the voice intro, and the download flow are all arranged to make the
          vault feel valuable the moment the first screen lands.
        </p>
      </Reveal>
